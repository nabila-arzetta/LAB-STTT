...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo <strong><?php echo e($name); ?></strong>,</p>
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> Inventaris Laboratorium. </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\magang - fix\LAB-STTT\backend\resources\views/emails/reset-password.blade.php ENDPATH**/ ?>